...
exports.createJournaling = async (req, res) => {
  try {
    ...
    const { content, created_date, user_id, question } = req.body;
...
exports.updateJournaling = async (req, res) => {
  try {
    ...
    // Log the journal entry before update
    console.log("Found journal entry:", journaling);

    // Update the journal entry
    await journaling.update({
      content: content || journaling.content,
      question: question || journaling.question, 
    });
